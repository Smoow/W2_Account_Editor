...
namespace EditorAccounts
{
    public partial class Form5 : Form
    {
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                foreach (DataGridViewRow row in Form1.dataGridView2.SelectedRows)
                {
                    ...
                    External.g_pAcccount.Cargo[index].sIndex = Convert.ToInt16(txtItemIndex.Text);
                    External.g_pAcccount.Cargo[index].sEffect[0].cEfeito = Convert.ToByte(txtEF1.Text);
                    External.g_pAcccount.Cargo[index].sEffect[0].cValue = Convert.ToByte(txtEFv1.Text);
                    External.g_pAcccount.Cargo[index].sEffect[1].cEfeito = Convert.ToByte(txtEF2.Text);
                    External.g_pAcccount.Cargo[index].sEffect[1].cValue = Convert.ToByte(txtEFv2.Text);
                    External.g_pAcccount.Cargo[index].sEffect[2].cEfeito = Convert.ToByte(txtEF3.Text);
                    External.g_pAcccount.Cargo[index].sEffect[2].cValue = Convert.ToByte(txtEFv3.Text);
